...
namespace MMDB.Shared
{
	...
	{
		public RecordNotFoundException(Type recordType, object recordID) : base(FormatMessage(recordType,recordID))
		{			
		}
        ...
        private static string FormatMessage(Type recordType, object recordID)
		{
